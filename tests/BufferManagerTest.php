 ...
 * @internal
 */
#[CoversClass(BufferManager::class)]
final class BufferManagerTest extends TestCase
{
    ...
    public function testCleanExpiredBuffers(): void
    {
        $connectionId = 'test-connection';
        $data = 'Hello, World!';
        ...
        $cleaned = $this->bufferManager->cleanExpiredBuffers(0.0);

        self::assertGreaterThan(0, $cleaned);
        self::assertTrue($this->bufferManager->isReceiveBufferEmpty($connectionId));
    }

    public function testClearReceiveBuffer(): void
    {
        $connectionId = 'test-connection';
        $data = 'Hello, World!';
        ...
        $this->bufferManager->clearReceiveBuffer($connectionId);
        self::assertTrue($this->bufferManager->isReceiveBufferEmpty($connectionId));
    }
    ...
    public function testClearSendBuffer(): void
    {
        ...
        $this->bufferManager->writeToSendBuffer($connectionId, $data);
        self::assertFalse($this->bufferManager->isSendBufferEmpty($connectionId));

        $this->bufferManager->clearSendBuffer($connectionId);
        self::assertTrue($this->bufferManager->isSendBufferEmpty($connectionId));
    }

    public function testCreateSendBuffer(): void
    {
        $connectionId = 'test-connection';
        $this->bufferManager->createSendBuffer($connectionId);

        self::assertTrue($this->bufferManager->isSendBufferEmpty($connectionId));
        self::assertSame(0, $this->bufferManager->getSendBufferSize($connectionId));
    }

    public function testReadFromSendBuffer(): void
    {
        $connectionId = 'test-connection';
        $data = 'Hello, World!';

        $this->bufferManager->writeToSendBuffer($connectionId, $data);
        $readData = $this->bufferManager->readFromSendBuffer($connectionId);

        self::assertSame($data, $readData);
        self::assertTrue($this->bufferManager->isSendBufferEmpty($connectionId));
    }

    public function testWriteToSendBuffer(): void
    {
        $connectionId = 'test-connection';
        $data = 'Hello, World!';

        $result = $this->bufferManager->writeToSendBuffer($connectionId, $data);

        self::assertTrue($result);
        self::assertFalse($this->bufferManager->isSendBufferEmpty($connectionId));
        self::assertSame(strlen($data), $this->bufferManager->getSendBufferSize($connectionId));
    }

    public function testClearAllBuffers(): void
    {
        $connectionId = 'test-connection';
        $data = 'Hello, World!';
